...
internal class CartScreenTest : AbstractEndpointTest() {
    ...
    fun empty() {
        ...
        assertEndpointEquals("/store/screens/cart/empty.json", url)
    }
    ...
    fun cart() {
        ...
        assertEndpointEquals("/store/screens/cart/cart.json", url)
    }
    ...
    fun outOfStock() {
        ...
        assertEndpointEquals("/store/screens/cart/cart-out-of-stock.json", url)
    }
}
