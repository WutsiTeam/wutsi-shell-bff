...
internal class MarketplaceScreenTest : AbstractEndpointTest() {
    ...
    @Test
    fun index() {
        assertEndpointEquals("/store/screens/marketplace/index.json", url)
    }
    ...
    fun empty() {
        ...
        assertEndpointEquals("/store/screens/marketplace/empty.json", url)
    }
    ...
    fun openedCart() {
        ...
        // GIVEN
        assertEndpointEquals("/store/screens/marketplace/opened-cart.json", url)
    }
}
