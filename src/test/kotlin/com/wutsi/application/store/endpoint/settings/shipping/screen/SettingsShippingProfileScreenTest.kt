...
internal class SettingsShippingProfileScreenTest : AbstractEndpointTest() {
    ...
    fun localPickup() {
        ...
        assertEndpointEquals("/store/screens/settings/shipping/profile-local-pickup.json", url)
    }
    ...
    fun localDelivery() {
        ...
        val url = "http://localhost:$port/settings/store/shipping/profile?id=111"
        assertEndpointEquals("/store/screens/settings/shipping/profile-local-delivery.json", url)
    }
    ...
    fun emailDelivery() {
        ...
        val url = "http://localhost:$port/settings/store/shipping/profile?id=111"
        assertEndpointEquals("/store/screens/settings/shipping/profile-email-delivery.json", url)
    }
    ...
    fun inStorePickup() {
        ...
        val url = "http://localhost:$port/settings/store/shipping/profile?id=111"
        assertEndpointEquals("/store/screens/settings/shipping/profile-in-store-pickup.json", url)
    }
}
