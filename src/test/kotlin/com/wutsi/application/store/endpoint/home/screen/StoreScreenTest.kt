...
internal class StoreScreenTest : AbstractEndpointTest() {
    @LocalServerPort
    val port: Int = 0
    ...
    fun empty() {
        ...
        val url = "http://localhost:$port/store"
        assertEndpointEquals("/store/screens/home/catalog-empty.json", url)
    }

    @Test
    fun myCatalog() {
        val url = "http://localhost:$port/store"
        assertEndpointEquals("/store/screens/home/catalog-me.json", url)
    }
    ...
    fun cartEnabled() {
        ...
        val url = "http://localhost:$port/store"
        assertEndpointEquals("/store/screens/home/catalog-with-cart-enabled.json", url)
    }
}
