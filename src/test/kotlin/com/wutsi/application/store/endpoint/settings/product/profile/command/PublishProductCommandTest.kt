...
internal class PublishProductCommandTest : AbstractEndpointTest() {
    ...
    fun publish() {
        // WHEN
        val url = "http://localhost:$port/commands/publish-product?id=$productId&value=true"
    ...
    fun unpublish() {
        // WHEN
        val url = "http://localhost:$port/commands/publish-product?id=$productId&value=false"
