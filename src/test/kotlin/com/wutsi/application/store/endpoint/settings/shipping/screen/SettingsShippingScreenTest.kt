...
internal class SettingsShippingScreenTest : AbstractEndpointTest() {
    ...
    fun index() {
        ...
        assertEndpointEquals("/store/screens/settings/shipping/shipping.json", url)
    }
    ...
    fun emailDeliveryEnabled() {
        ...
        val url = "http://localhost:$port/settings/store/shipping"
        assertEndpointEquals("/store/screens/settings/shipping/shipping-email-delivery-enabled.json", url)
    }
    ...
    fun internationalDeliveryEnabled() {
        ...
        val url = "http://localhost:$port/settings/store/shipping"
        assertEndpointEquals("/store/screens/settings/shipping/shipping-international-delivery-enabled.json", url)
    }
    ...
    fun localPickupEnabled() {
        ...
        val url = "http://localhost:$port/settings/store/shipping"
        assertEndpointEquals("/store/screens/settings/shipping/shipping-local-pickup-enabled.json", url)
    }
    ...
    fun localDeliveryEnabled() {
        ...
        val url = "http://localhost:$port/settings/store/shipping"
        assertEndpointEquals("/store/screens/settings/shipping/shipping-local-delivery-enabled.json", url)
    }
    ...
    fun inStorePickupEnabled() {
        ...
        val url = "http://localhost:$port/settings/store/shipping"
        assertEndpointEquals("/store/screens/settings/shipping/shipping-in-store-pickup-enabled.json", url)
    }
}
