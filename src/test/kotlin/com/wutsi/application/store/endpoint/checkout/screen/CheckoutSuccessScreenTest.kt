...
internal class CheckoutSuccessScreenTest : AbstractEndpointTest() {
    ...
    fun success() {
        ...
        assertEndpointEquals("/store/screens/checkout/success.json", url)
    }
    ...
    fun error() {
        ...
        assertEndpointEquals("/store/screens/checkout/error.json", url)
    }
    ...
    fun timeout() {
        ...
        val url = "http://localhost:$port/checkout/success?order-id=${order.id}&transaction-id=${tx.id}"
        assertEndpointEquals("/store/screens/checkout/timeout.json", url)
    }
