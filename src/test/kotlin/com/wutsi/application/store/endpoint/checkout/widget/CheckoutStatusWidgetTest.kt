...
internal class CheckoutStatusWidgetTest : AbstractEndpointTest() {
    ...
    fun pending() {
        ...
        assertEndpointEquals("/store/widgets/checkout/status-pending.json", url)
    ...
    fun success() {
        ...
        val url = "http://localhost:$port/widgets/checkout-status?transaction-id=1111&count=1"
        assertEndpointEquals("/store/widgets/checkout/status-success.json", url)
    ...
    fun failed() {
        ...
        val url = "http://localhost:$port/widgets/checkout-status?transaction-id=1111&count=1"
        assertEndpointEquals("/store/widgets/checkout/status-failed.json", url)
    ...
    fun tooManyRetries() {
        ...
        assertEndpointEquals("/store/widgets/checkout/status-too-many-tries.json", url)
    }
