...
internal class CheckoutReviewScreenTest : AbstractEndpointTest() {
    ...
    fun index() {
        ...
        assertEndpointEquals("/store/screens/checkout/review.json", url)
    }
    ...
    fun shippingEnabled() {
        ...
        val url = "http://localhost:$port/checkout/review?order-id=111"
        assertEndpointEquals("/store/screens/checkout/review-shipping-enabled.json", url)
    }
    ...
    fun paymentEnabled() {
        ...
        val url = "http://localhost:$port/checkout/review?order-id=111"
        assertEndpointEquals("/store/screens/checkout/review-payment-enabled.json", url)
    }
}
