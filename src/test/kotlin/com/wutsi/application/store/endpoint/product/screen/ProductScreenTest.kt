...
import com.wutsi.application.TrackingHttpRequestInterceptor
...
internal class ProductScreenTest : AbstractEndpointTest() {
    ...
    fun productWithImage() {
        ...
        assertEndpointEquals("/store/screens/product/product-with-image.json", url)
    ...
    fun productWithStatisticsEnabled() {
        ...
        assertEndpointEquals("/store/screens/product/product-with-statistics-enabled.json", url)
    ...
    fun numericProduct() {
        ...
        assertEndpointEquals("/store/screens/product/product-numeric.json", url)
        assertNoTracking(product)
    }
    ...
    fun productWithCartEnabled() {
        ...
        assertEndpointEquals("/store/screens/product/product-with-cart-enabled.json", url)
        assertNoTracking(product)
    }

    @Test
    fun productWithChatEnabled() {
        ...
        assertEndpointEquals("/store/screens/product/product-with-chat-enabled.json", url)
        assertNoTracking(product)
    }
    ...
    fun productWithProductInCart() {
        ...
        assertEndpointEquals("/store/screens/product/product-in-cart.json", url)
        assertNoTracking(product)
    }
    ...
    fun productNoStock() {
        ...
        assertEndpointEquals("/store/screens/product/product-no-stock.json", url)
        assertNoTracking(product)
    }
