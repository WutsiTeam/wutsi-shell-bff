...
internal class SettingsShippingProfileStreetScreenTest : AbstractEndpointTest() {
    @LocalServerPort
    val port: Int = 0
    ...
    fun index() {
        ...
        val url = "http://localhost:$port/settings/store/shipping/attribute/street?id=111"
        assertEndpointEquals("/store/screens/settings/shipping/street.json", url)
    }
}
