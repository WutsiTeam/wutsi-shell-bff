...
internal class SettingsStoreScreenTest : AbstractEndpointTest() {
    ...
    @Test
    fun index() {
        assertEndpointEquals("/store/screens/settings/store/store.json", url)
    }
    ...
    fun shippingEnabled() {
        ...
        assertEndpointEquals("/store/screens/settings/store/store-shipping-enabled.json", url)
    }
    ...
    fun statisticsEnabled() {
        ...
        assertEndpointEquals("/store/screens/settings/store/store-statistics-enabled.json", url)
    }
    ...
    fun orderEnambled() {
        ...
        assertEndpointEquals("/store/screens/settings/store/store-order-enabled.json", url)
    }
}
