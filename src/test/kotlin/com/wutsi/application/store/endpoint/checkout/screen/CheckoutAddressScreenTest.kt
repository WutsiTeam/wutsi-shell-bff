...
internal class CheckoutAddressScreenTest : AbstractEndpointTest() {
    ...
    fun postal() {
        ...
        assertEndpointEquals("/store/screens/checkout/addresses-postal.json", url)
    }
    ...
    fun email() {
        ...
        // WHEN
        val url = "http://localhost:$port/checkout/address?order-id=111"
        assertEndpointEquals("/store/screens/checkout/addresses-email.json", url)
    }
    ...
    fun empty() {
        ...
        val url = "http://localhost:$port/checkout/address?order-id=111"
        assertEndpointEquals("/store/screens/checkout/addresses-empty.json", url)
    }
}
