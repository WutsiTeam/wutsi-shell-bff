...
internal class VerifySmsCodeCommandTest : AbstractEndpointTest() {
    ...
    fun index() {
        ...
        assertEquals(
            "https://wutsi-gateway-test.herokuapp.com/login/?phone=%2B1237666666666&screen-id=page.settings.account.link.pin&title=Authorization&sub-title=Enter+your+Wutsi+PIN+to+link+the+account&auth=false&return-to-route=false&dark-mode=true&return-url=http%3A%2F%2Flocalhost%3A0%2Fcommands%2Flink-account",
            action.url
        )
