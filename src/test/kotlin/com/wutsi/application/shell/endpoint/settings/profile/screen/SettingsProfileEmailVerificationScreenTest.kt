...
internal class SettingsProfileEmailVerificationScreenTest : AbstractShellEndpointTest() {
    @LocalServerPort
    val port: Int = 0
    ...
    fun index() {
        // THEN
        assertEndpointEquals("/shell/screens/settings/profile/email-verification.json", url)
    }
}
