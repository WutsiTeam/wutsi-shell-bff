...
internal class SettingsV2CatalogScreenTest : AbstractSecuredEndpointTest() {
    @LocalServerPort
    val port: Int = 0
    ...
    private fun url() = "http://localhost:$port${Page.getSettingsCatalogUrl()}"
    ...
    override fun setUp() {
        ...
        val products = listOf(
            Fixtures.createProductSummary(1, "Product1"),
    ...
    @Test
    fun index() = assertEndpointEquals("/marketplace/settings/catalog/home/screens/products.json", url())
    ...
    fun limit() {
        ...
        assertEndpointEquals("/marketplace/settings/catalog/home/screens/products-limit.json", url())
    }
}
