...
internal class TransactionScreenTest : AbstractEndpointTest() {
    ...
    fun transfer() {
        ...
        assertEndpointEquals("/cash/screens/transaction/transaction-transfer.json", url)
    }
    ...
    fun cashin() {
        ...
        assertEndpointEquals("/cash/screens/transaction/transaction-cashin.json", url)
    }
    ...
    fun cashout() {
        ...
        assertEndpointEquals("/cash/screens/transaction/transaction-cashout.json", url)
    }
    ...
    fun chargeSend() {
        ...
        assertEndpointEquals("/cash/screens/transaction/transaction-charge-sent.json", url)
    }
    ...
    fun chargeReceived() {
        ...
        assertEndpointEquals("/cash/screens/transaction/transaction-charge-received.json", url)
    }
