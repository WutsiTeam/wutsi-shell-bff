...
internal class TransactionProcessingScreenTest : AbstractEndpointTest() {
    ...
    fun transfer() {
        ...
        assertEndpointEquals("/cash/screens/transaction/processing-transfer.json", url)
    }
    ...
    fun cashin() {
        ...
        val url = "http://localhost:$port/transaction/processing?order-id=111&transaction-id=555"
        assertEndpointEquals("/cash/screens/transaction/processing-cashin.json", url)
    }
    ...
    fun cashout() {
        ...
        val url = "http://localhost:$port/transaction/processing?order-id=111&transaction-id=555"
        assertEndpointEquals("/cash/screens/transaction/processing-cashout.json", url)
    }
