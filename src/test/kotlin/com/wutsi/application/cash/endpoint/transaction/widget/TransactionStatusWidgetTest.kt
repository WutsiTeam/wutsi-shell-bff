...
internal class TransactionStatusWidgetTest : AbstractEndpointTest() {
    ...
    fun pending() {
        ...
        assertEndpointEquals("/cash/widgets/transaction/status-pending.json", url)
    }
    ...
    fun `success TRANSFER`() {
        ...
        val url = "http://localhost:$port/widgets/transaction/status?transaction-id=1111&count=1"
        assertEndpointEquals("/cash/widgets/transaction/status-success-transfer.json", url)
    }
    ...
    fun `success CASHIN`() {
        ...
        val url = "http://localhost:$port/widgets/transaction/status?transaction-id=1111&count=1"
        assertEndpointEquals("/cash/widgets/transaction/status-success-cashin.json", url)
    }
    ...
    fun `success CASHOUT`() {
        ...
        val url = "http://localhost:$port/widgets/transaction/status?transaction-id=1111&count=1"
        assertEndpointEquals("/cash/widgets/transaction/status-success-cashout.json", url)
    }
    ...
    fun failed() {
        ...
        val url = "http://localhost:$port/widgets/transaction/status?transaction-id=1111&count=1"
        assertEndpointEquals("/cash/widgets/transaction/status-failed.json", url)
    }
    ...
    fun tooManyTries() {
        ...
        assertEndpointEquals("/cash/widgets/transaction/status-too-many-tries.json", url)
    }
